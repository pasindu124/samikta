                ...
                <div class="container-fluid">
                 ...
                 <p class="category"></p>
                             ...
                             <div class="card-content">
                               <?php if ($this->session->flashdata('projadd')) {
                                 echo ($this->session->flashdata('projadd'));
                                         ...
                                         <div class="col-md-12">
                                             <div class="form-group">
                                                   ...
                                                   <div class="form-group label-floating">
                                                       ...
                                                       <!-- <textarea class="form-control" name="description" rows="5" value="" ></textarea> -->

                                                       <div class="col-md-12">
                                                       		<br/>
                                                       		<label></label>		<textarea name="description" id="news_description" class="form-control" rows="16"></textarea>
